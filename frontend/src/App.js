            ...
            <div className="border-t border-gray-800 pt-6 sm:pt-8">
              <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                ...
                <div className="flex items-center space-x-3 sm:space-x-4" role="list" aria-label="Social media links">
                  {[
                    { 
                      href: "https://web.facebook.com/recalibratepain/", 
                    ...
                    { 
                      ...
                      label: "Pinterest",
                      path: "M12 0C5.374 0 0 5.373 0 12 0 17.302 3.438 21.8 8.207 23.387c-.113-.949-.21-2.405.044-3.44.232-.93 1.5-6.35 1.5-6.35s-.384-.768-.384-1.902c0-1.78 1.033-3.11 2.318-3.11 1.094 0 1.622.82 1.622 1.802 0 1.098-.7 2.738-.1.062-4.27c-.754 0-1.368.635-1.368 1.39 0 .305.113.63.255.98.372.586 1.024.767 1.676.767.8 0 1.41-.31 1.824-.824.414-.515.62-1.19.62-2.023 0-1.732-1.24-2.94-3.014-2.94-2.054 0-3.26 1.54-3.26 3.13 0 .62.24 1.29.54 1.65.06.07.068.13.05.2-.055.23-.18.72-.205.82-.033.13-.108.16-.25.1-1.45-.67-2.36-2.77-2.36-4.46 0-3.64 2.64-6.98 7.61-6.98 4 0 7.11 2.85 7.11 6.66 0 3.97-2.5 7.17-5.98 7.17-1.17 0-2.27-.61-2.64-1.34l-.72 2.74c-.26.99-.96 2.23-1.43 2.99C9.57 23.8 10.76 24 12.02 24c6.62 0 11.98-5.37 11.98-12C24 5.37 18.63.01 12.02.01z"
                    }
                  ].map((social, index) => (
                    <a 
                      key={index} 
